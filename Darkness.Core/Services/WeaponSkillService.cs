...
public class WeaponSkillService : IWeaponSkillService
{
    public List<Skill> GetSkillsForWeapon(string weaponType, string shieldType)
    {
        ...
        else if (weaponType.Contains("Dagger"))
        {
            skills.Add(new Skill
            {
                Name = "Quick Stab", Description = "A lightning-fast strike. (1.0x Dmg, +20 Accuracy)",
        ...
        else if (weaponType.Contains("Axe"))
        {
            ...
            skills.Add(new Skill
            {
                Name = "Overhead Strike", Description = "A precise armor-piercing jab. (0.9x Dmg, 30% Armor Pen)",
        ...
        else
        {
            ...
            skills.Add(new Skill
            {
                Name = "Block", Description = "Attempts to block incoming attacks. (10% Block)",
                SkillType = "Defensive", BlockReduction = 0.1f, AssociatedAction = ActionType.Block
            });
        }
